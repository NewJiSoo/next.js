...
[**`next/font`**](/docs/01-app/03-api-reference/02-components/font.mdx) will automatically optimize your fonts (including custom fonts) and remove external network requests for improved privacy and performance.
